...
return [
    ...
    'views' => [
        [
	    'region' => 'header',
	    'template' => 'duplo/header',
	    'data' => [
		'siteTitle' => 'MoppeTrim overflow',
		'siteTagline' => 'Fort...Fortare...MoppeTrim overflow'], 'sort' => -1,
	],
        [
	    'region' => 'footer',
	    'template' => 'duplo/footer',
	    'data' => ['siteFooter' => 'Website powered by AnaxMVC'],
	    'sort' => -1],
	[
	    'region' => 'navbar',
	    'template' => [
    ...
    'data' => [
        ...
        'title_append' => ' | Moppetrim overflow',
